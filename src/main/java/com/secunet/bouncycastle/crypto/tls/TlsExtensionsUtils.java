...
public class TlsExtensionsUtils
{
    ...
    public static final Integer EXT_session_ticket = Integers.valueOf(ExtensionType.session_ticket);
    ...
    {
        extensions.put(EXT_session_ticket, createSessionTicketExtension());
    }
	...
	public static byte[] getSessionTicketExtension(Hashtable extensions)
	        throws IOException
	{
		byte[] extensionData = TlsUtils.getExtensionData(extensions, EXT_session_ticket);
		return extensionData == null ? null : readSessionTicketExtension(extensionData);
	}
	...
	public static boolean hasSessionTicketExtension(Hashtable extensions)
	{
		return extensions == null ? false : extensions.containsKey(EXT_session_ticket);
	}
    ...
    public static byte[] createSessionTicketExtension()
    {
        return createEmptyExtensionData();
    }
	...
	public static byte[] readSessionTicketExtension(byte[] extensionData)
	        throws IOException
	{
        if (extensionData == null)
        {
